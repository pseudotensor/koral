...
//  char bufor[50];
  ...
  fprintf(fgnu,
	  ...
	  "unset surface\n"
	  "set log z\n"
	  "set cntrparam level discrete 10,100,500\n"
	  ...
	  ,fname,fname2,get_x(-NG,0),get_xb(NX,0),get_xb(0,1),get_xb(NY,1),fname,get_x(-NG,0),get_xb(NX,0),get_xb(0,1),get_xb(NY,1),fname,fname,(int)(NX/20),(int)(NY/8)  );
