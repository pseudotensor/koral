...
/****************************************/
   fprintf(fgnu,
	  ...
	  "set xlabel \"\"\n"
	  "set ylabel \"\"\n"
	  "plot \"%s\" u 1:($24+1.e-80) w lp ls 2 pt 7 ps .5  ti \"R[0][0]\"\n"
	  ...
	  "set ylabel \"\"\n"
	  //	  "set log y\n"
	  "plot \"%s\" u 1:($25+1.e-80) w lp ls 3 pt 7 ps .5 ti \"R[0][1]\"\n"
	  //	  "unset log y\n"
	  ...
	  "set xlabel \"\"\n"
	  "set ylabel \"\"\n"
	  "plot \"%s\" u 1:($26+1.e-80) w p ls 4 pt 7 ti \"R[1][1]\"\n"
	  ...
	  "set xlabel \"\"\n"
	  "set ylabel \"\"\n"
	  "plot \"%s\" u 1:($27+1.e-80) w lp ls 4 pt 7 ti \"R[2][2]\""
