...
/****************************************/
   fprintf(fgnu,
	  ...
	  "unset log y\n"
	  "set ylabel \"rho\"\n"
	  "plot \"%s\" u 1:($14) w p ls 1 pt 7 ps .5\n"
	  //	  "set autoscale\n"
	  "set origin 0,0\n"
	  "unset log y\n"
	  //	  "set yrange [-120000:120000]\n"
	  "set ylabel \"velocity\"\n"
	  "plot \"%s\" u 1:($16/$14) w p ls 2 pt 7 ps .5\n"

	  "set origin .5,.5\n"
	  //	  "set yrange [1e11:5e12]\n"
	  "unset log y\n"
	  "set ylabel \"unknown\"\n"
	  "plot \"%s\" u 1:15 w p ls 3 pt 7 ps .5 \n"
	  ...
	  //	  "set autoscale\n"
	  "set ylabel \"unknown\"\n"
	  "plot \"%s\" u 1:($17/$14) w p ls 4 pt 7 \n"
	  ,fname2,get_xb(-NG,0),get_xb(NX+NG,0),fname,fname,fname,fname);
