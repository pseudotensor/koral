...
int calc_varscalars(ldouble*,ldouble);
...
#define get_Tfull(uarr,i,j,ix,iy,iz) uarr[i*4+j + (iX(ix)+(NGCX))*16 + (iY(iy)+(NGCY))*(SX)*16 + (iZ(iz)+(NGCZ))*(SY)*(SX)*16]
...
int calc_Krzysie_arb_ana(ldouble*,ldouble[][4][4],int);
...
int calc_taueff(ldouble *pp, void*, ldouble *dl, ldouble *tauabs);
int calc_Gi(ldouble *pp, void*,ldouble Gi[4],int);
int calc_Gi_nonrel(ldouble *pp, void*,ldouble Gi[4],int);
